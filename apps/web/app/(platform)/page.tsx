    ...
    <>
      ...
      <section className="bg-brand-navy py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href="/application"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-brand-gold hover:bg-brand-gold-dark text-white font-semibold text-sm transition-colors"
          >
